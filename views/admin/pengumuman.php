                        ...
                        <tbody>
                            <?php foreach ($pengumumanList as $p): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= htmlspecialchars($p['target_display'] ?? 'Semua Mahasiswa') ?></td>
                ...
                <div class="modal-body">
                    <form id="formTambahPengumuman">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="select-wrapper">
                                <select name="target_type" id="tambahTargetType" class="form-control" required onchange="handleTargetChange('tambah')">
                        ...
                        <div id="tambahJurusanField" class="mb-3 conditional-field">
                            ...
                            <div class="select-wrapper">
                                <select name="target_jurusan_id" id="tambahJurusan" class="form-control" onchange="handleJurusanChange('tambah')">
                                    <option value="">Pilih Jurusan</option>
                                    <?php foreach ($jurusan as $j): ?>
                                        <option value="<?= $j['jurusan_id'] ?>"><?= htmlspecialchars($j['nama_jurusan']) ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <i class="bi bi-chevron-down"></i>
                            </div>
                        ...
                        <div id="tambahProdiField" class="mb-3 conditional-field">
                            ...
                            <div class="select-wrapper">
                                <select name="target_prodi_id" id="tambahProdi" class="form-control" onchange="handleProdiChange('tambah')">
                ...
                <div class="modal-body">
                    <form id="formEditPengumuman">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Pengumuman Untuk <span class="text-danger">*</span></label>
                            <div class="select-wrapper">
                                <select name="target_type" id="editTargetType" class="form-control" required onchange="handleTargetChange('edit')">
                                    <option value="">Pilih Target</option>
                                    <option value="all">Semua Mahasiswa</option>
                                    <option value="jurusan">Jurusan</option>
                                </select>
                        ...
                        <div id="editJurusanField" class="mb-3 conditional-field">
                            <label class="form-label">Jurusan <span class="text-danger">*</span></label>
                            <div class="select-wrapper">
                                <select name="target_jurusan_id" id="editJurusan" class="form-control" onchange="handleJurusanChange('edit')">
                                    <option value="">Pilih Jurusan</option>
                                    <?php foreach ($jurusan as $j): ?>
                                        <option value="<?= $j['jurusan_id'] ?>"><?= htmlspecialchars($j['nama_jurusan']) ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div id="editProdiField" class="mb-3 conditional-field">
                            <label class="form-label">Prodi <span class="text-danger">*</span></label>
                            <div class="select-wrapper">
                                <select name="target_prodi_id" id="editProdi" class="form-control" onchange="handleProdiChange('edit')">
                                    <option value="">Pilih Prodi</option>
                                </select>
                                <i class="bi bi-chevron-down"></i>
                            </div>

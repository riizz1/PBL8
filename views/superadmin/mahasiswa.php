...
<body class="mahasiswa-page d-flex flex-column min-vh-100">
    ...
    <!-- MODAL EDIT MAHASISWA - SUPERADMIN -->
                ...
                <div class="modal-body">
                    <form id="formEditMahasiswa">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="prodi_id" id="editProdi" class="form-select" required>
                                <option value="">Pilih Prodi</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kelas" id="editKelas" class="form-control" required
                                placeholder="Masukkan Kelas | Contoh: IF1A-Pagi">
                        </div>
